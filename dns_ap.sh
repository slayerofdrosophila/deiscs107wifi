...
dnsmasq --interface=$WIFI_INTERFACE --dhcp-range=${GATEWAY_IP%.*}.10,${GATEWAY_IP%.*}.250,255.255.255.0,12h --address=/example.com/${LOCAL_IP} --log-queries --log-facility=/var/log/dns.log &
