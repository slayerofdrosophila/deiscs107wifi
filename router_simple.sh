...
WIFI_INTERFACE="wlx3c3332cf3088"       # Your wireless interface name
INTERNET_INTERFACE="wlo1"      # Your internet-facing interface name
...
dnsmasq --interface=$WIFI_INTERFACE --dhcp-range=${GATEWAY_IP%.*}.10,${GATEWAY_IP%.*}.250,255.255.255.0,12h &
